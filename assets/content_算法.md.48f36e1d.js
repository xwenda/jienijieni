import{_ as s,o as a,c as n,X as t}from"./chunks/framework.79f01d3e.js";const d=JSON.parse('{"title":"算法","description":"","frontmatter":{},"headers":[],"relativePath":"content/算法.md"}'),e={name:"content/算法.md"},l=t(`<h1 id="算法" tabindex="-1">算法 <a class="header-anchor" href="#算法" aria-label="Permalink to &quot;算法&quot;">​</a></h1><h2 id="快排" tabindex="-1">快排 <a class="header-anchor" href="#快排" aria-label="Permalink to &quot;快排&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">function quickSort(arr) {</span></span>
